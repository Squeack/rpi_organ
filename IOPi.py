...
class IOPi(object):
    ...
    def print_bus_status(self):
        print "Bus at address: {}".format(self.__ioaddress)
        print "Port A direction: {}".format(tobin(self.__port_a_direction))
        print "Port A pullups: {}".format(tobin(self.__port_a_pullup))
        print "Port A polarity: {}".format(tobin(self.__port_a_polarity))
        print "Port B direction: {}".format(tobin(self.__port_b_direction))
        print "Port B pullups: {}".format(tobin(self.__port_b_pullup))
        print "Port B polarity: {}".format(tobin(self.__port_b_polarity))
        return
